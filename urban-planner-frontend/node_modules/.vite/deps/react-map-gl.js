...
var Map = (0, import_react3.forwardRef)((props, ref) => {
  ...
  (0, import_react3.useEffect)(() => {
    ...
    let isMounted = true;
    let mapbox;
    Promise.resolve(mapLib || import("./mapbox-gl-ME4EHOA7.js")).then((mapboxgl) => {
      if (!isMounted) {
        return;
      }
      if (!mapboxgl.Map) {
  ...
  return React2.createElement("div", { id: props.id, ref: containerRef, style }, mapInstance && React2.createElement(MapContext.Provider, { value: contextValue }, props.children));
});
Map.displayName = "Map";
